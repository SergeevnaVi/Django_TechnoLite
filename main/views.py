...
def about(request):
    ...
    context = {
        ...
        'mission': 'Наша миссия',
        'text_mission': (
            'Мы стремимся сделать вашу жизнь комфортнее и удобнее, предлагая технику, '
            'которая упрощает ваш быт и повышает его качество. Каждый клиент важен для нас, '
            'и мы всегда готовы предоставить лучший сервис.'
        ),
...
def delivery_and_payment(request):
    ...
    context = {
        ...
        'text_on_page': (
            'Мы предлагаем несколько удобных способов доставки и оплаты для наших клиентов. '
