...
3. **Корзина и оформление заказов**
   ...
   Позволяет добавлять товары, выбирать способ оплаты (наличными, картой при получении или онлайн) и указывать адрес доставки.
...
✔️ Предоставить пользователям удобный интерфейс для выбора и покупки бытовой техники.  
✔️ Создать учетные записи для пользователей с возможностью отслеживания истории заказов и личной информации.  
✔️ Обеспечить защиту данных с использованием хеширования паролей и безопасного подключения к базе данных.  
✔️ Реализовать фильтры для быстрого поиска товаров по различным параметрам, а также добавить поисковую строку.  
...
- Просматривать все товары в каталоге, фильтровать их по скидке и цене.
- При просмотре товара добавить его в корзину для последующего оформления заказа.
- После добавления товаров в корзину перейти к оформлению заказа, где указывает свои данные для доставки и способа оплаты.
...
[3.1]: readme_assets/login_in_up.png
...
[![catalog_products_filter][4.1]][4.1]
 
[4.1]: readme_assets/catalog_products_filter.png
...
[![catalog_products_details][4.2]][4.2]
 
[4.2]: readme_assets/catalog_products_details.png
...
[![catalog_products_details_1][5.1]][5.1]
 
[5.1]: readme_assets/catalog_products_details_1.png
 
</details>

3. После этого откроется всплывающее окно или появится сообщение, подтверждающее, что товар успешно добавлен в корзину.

4. Если это окно не появляется, проверьте, добавлен ли товар в корзину через иконку корзины на главной странице или в меню.
...
4. На следующем шаге вам будет предложено ввести данные для доставки:
    ...
    - Адрес доставки: Если вам нужна доставка, то введите адрес доставки, на который должен быть доставлен товар. Если не нужна доставка, то выбирайте "Самовывоз".
